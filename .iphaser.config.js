...
const config = {
  phaser2: {
    ...
    templatePath: path.resolve(homeDir, '.iphaser', './storage/templates/v2'),
    docRemote: 'https://github.com/photonstorm/phaser.git',
    docPull: 'git pull origin render-pass',
    docPath: path.resolve(homeDir, '.iphaser', './storage/docs/v2/'),
    docRoot: path.resolve(homeDir, '.iphaser', './storage/docs/v2/v2/docs/'),
    docSparse: ['v2/docs'],
  },
  phaser3: {
    name: 'phaser3',
    ...
    templatePath: path.resolve(homeDir, '.iphaser', './storage/templates/v3'),
    docRemote: 'https://github.com/photonstorm/phaser3-docs.git',
    docPull: 'git pull origin master',
    docPath: path.resolve(homeDir, '.iphaser', './storage/docs/v3/'),
    docRoot: path.resolve(homeDir, '.iphaser', './storage/docs/v3/docs/'),
